 ...
 */
class Composant extends \SYM16\SimpleStockBundle\Entity\Composant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Composant' . "\0" . 'famille', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Composant' . "\0" . 'id', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Composant' . "\0" . 'nom', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Composant' . "\0" . 'createur', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Composant' . "\0" . 'creation', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Composant' . "\0" . 'modification'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Composant $proxy) {
