 ...
 */
class Emplacement extends \SYM16\SimpleStockBundle\Entity\Emplacement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Emplacement' . "\0" . 'entrepot', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Emplacement' . "\0" . 'id', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Emplacement' . "\0" . 'nom', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Emplacement' . "\0" . 'createur', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Emplacement' . "\0" . 'creation', '' . "\0" . 'SYM16\\SimpleStockBundle\\Entity\\Emplacement' . "\0" . 'modification'];
        }
