...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.dbal.logger.profiling.simplestock2' => 'getDoctrine_Dbal_Logger_Profiling_Simplestock2Service',
            'doctrine.dbal.logger.profiling.stockmaster' => 'getDoctrine_Dbal_Logger_Profiling_StockmasterService',
            'doctrine.dbal.simplestock2_connection' => 'getDoctrine_Dbal_Simplestock2ConnectionService',
            'doctrine.dbal.stockmaster_connection' => 'getDoctrine_Dbal_StockmasterConnectionService',
            ...
            'doctrine.orm.simplestock2_entity_listener_resolver' => 'getDoctrine_Orm_Simplestock2EntityListenerResolverService',
            'doctrine.orm.simplestock2_entity_manager' => 'getDoctrine_Orm_Simplestock2EntityManagerService',
            'doctrine.orm.simplestock2_manager_configurator' => 'getDoctrine_Orm_Simplestock2ManagerConfiguratorService',
            'doctrine.orm.stockmaster_entity_listener_resolver' => 'getDoctrine_Orm_StockmasterEntityListenerResolverService',
            'doctrine.orm.stockmaster_entity_manager' => 'getDoctrine_Orm_StockmasterEntityManagerService',
            'doctrine.orm.stockmaster_manager_configurator' => 'getDoctrine_Orm_StockmasterManagerConfiguratorService',
            'doctrine.orm.validator.unique' => 'getDoctrine_Orm_Validator_UniqueService',
            'doctrine.orm.validator_initializer' => 'getDoctrine_Orm_ValidatorInitializerService',
            'doctrine_cache.providers.doctrine.orm.default_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.default_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.default_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultResultCacheService',
            'doctrine_cache.providers.doctrine.orm.simplestock2_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_Simplestock2MetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.simplestock2_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_Simplestock2QueryCacheService',
            'doctrine_cache.providers.doctrine.orm.simplestock2_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_Simplestock2ResultCacheService',
            'doctrine_cache.providers.doctrine.orm.stockmaster_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_StockmasterMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.stockmaster_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_StockmasterQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.stockmaster_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_StockmasterResultCacheService',
            ...
            'sym16_simple_stock.isunique' => 'getSym16SimpleStock_IsuniqueService',
            'sym16_simple_stock.lister_tout' => 'getSym16SimpleStock_ListerToutService',
        ...
        $this->aliases = array(
            ...
            'doctrine.orm.simplestock2_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.simplestock2_metadata_cache',
            'doctrine.orm.simplestock2_query_cache' => 'doctrine_cache.providers.doctrine.orm.simplestock2_query_cache',
            'doctrine.orm.simplestock2_result_cache' => 'doctrine_cache.providers.doctrine.orm.simplestock2_result_cache',
            'doctrine.orm.stockmaster_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.stockmaster_metadata_cache',
            'doctrine.orm.stockmaster_query_cache' => 'doctrine_cache.providers.doctrine.orm.stockmaster_query_cache',
            'doctrine.orm.stockmaster_result_cache' => 'doctrine_cache.providers.doctrine.orm.stockmaster_result_cache',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SYM16SimpleStockBundle', ($this->targetDirs[2].'/Resources/SYM16SimpleStockBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SYM16SimpleStockBundle', ($this->targetDirs[3].'/src/SYM16/SimpleStockBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('default' => 'doctrine.dbal.default_connection', 'stockmaster' => 'doctrine.dbal.stockmaster_connection', 'simplestock2' => 'doctrine.dbal.simplestock2_connection'), array('default' => 'doctrine.orm.default_entity_manager', 'stockmaster' => 'doctrine.orm.stockmaster_entity_manager', 'simplestock2' => 'doctrine.orm.simplestock2_entity_manager'), 'default', 'default');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'simplestock', 'user' => 'simplestock', 'password' => 'simplestock', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }

    /**
     * Gets the 'doctrine.dbal.simplestock2_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\DBAL\Connection A Doctrine\DBAL\Connection instance.
     */
    protected function getDoctrine_Dbal_Simplestock2ConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.simplestock2'));

        $b = new \Doctrine\DBAL\Configuration();
        $b->setSQLLogger($a);

        return $this->services['doctrine.dbal.simplestock2_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'simplestock2', 'user' => 'simplestock', 'password' => 'simplestock', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }

    /**
     * Gets the 'doctrine.dbal.stockmaster_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\DBAL\Connection A Doctrine\DBAL\Connection instance.
     */
    protected function getDoctrine_Dbal_StockmasterConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.stockmaster'));

        $b = new \Doctrine\DBAL\Configuration();
        $b->setSQLLogger($a);

        return $this->services['doctrine.dbal.stockmaster_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'stockmaster', 'user' => 'simplestock', 'password' => 'simplestock', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/SYM16/SimpleStockBundle/Entity'), 1 => ($this->targetDirs[3].'/src/SYM16/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'SYM16\\SimpleStockBundle\\Entity');
        $c->addDriver($b, 'SYM16\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('SYM16SimpleStockBundle' => 'SYM16\\SimpleStockBundle\\Entity', 'SYM16UserBundle' => 'SYM16\\UserBundle\\Entity'));
    ...
    /**
     * Gets the 'doctrine.orm.simplestock2_entity_listener_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\Mapping\DefaultEntityListenerResolver A Doctrine\ORM\Mapping\DefaultEntityListenerResolver instance.
     */
    protected function getDoctrine_Orm_Simplestock2EntityListenerResolverService()
    {
        return $this->services['doctrine.orm.simplestock2_entity_listener_resolver'] = new \Doctrine\ORM\Mapping\DefaultEntityListenerResolver();
    }

    /**
     * Gets the 'doctrine.orm.simplestock2_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityManager A Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_Simplestock2EntityManagerService()
    {
        $a = $this->get('annotation_reader');
        ...
        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('SYM16SimpleStockBundle' => 'SYM16\\SimpleStockBundle\\Entity', 'SYM16UserBundle' => 'SYM16\\UserBundle\\Entity'));
        $d->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.simplestock2_metadata_cache'));
        $d->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.simplestock2_query_cache'));
        $d->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.simplestock2_result_cache'));
        $d->setMetadataDriverImpl($c);
        $d->setProxyDir((__DIR__.'/doctrine/orm/Proxies'));
        $d->setProxyNamespace('Proxies');
        $d->setAutoGenerateProxyClasses(true);
        ...
        $d->setNamingStrategy($this->get('doctrine.orm.naming_strategy.default'));
        $d->setQuoteStrategy($this->get('doctrine.orm.quote_strategy.default'));
        $d->setEntityListenerResolver($this->get('doctrine.orm.simplestock2_entity_listener_resolver'));

        $this->services['doctrine.orm.simplestock2_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.simplestock2_connection'), $d);

        $this->get('doctrine.orm.simplestock2_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.simplestock2_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator A Doctrine\Bundle\DoctrineBundle\ManagerConfigurator instance.
     */
    protected function getDoctrine_Orm_Simplestock2ManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.simplestock2_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }

    /**
     * Gets the 'doctrine.orm.stockmaster_entity_listener_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\Mapping\DefaultEntityListenerResolver A Doctrine\ORM\Mapping\DefaultEntityListenerResolver instance.
     */
    protected function getDoctrine_Orm_StockmasterEntityListenerResolverService()
    {
        return $this->services['doctrine.orm.stockmaster_entity_listener_resolver'] = new \Doctrine\ORM\Mapping\DefaultEntityListenerResolver();
    }

    /**
     * Gets the 'doctrine.orm.stockmaster_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityManager A Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_StockmasterEntityManagerService()
    {
        $a = $this->get('annotation_reader');

        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/SYM16/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/SYM16/SimpleStockBundle/Entity')));
        ...
        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('SYM16UserBundle' => 'SYM16\\UserBundle\\Entity', 'SYM16SimpleStockBundle' => 'SYM16\\SimpleStockBundle\\Entity'));
        $d->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.stockmaster_metadata_cache'));
        $d->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.stockmaster_query_cache'));
        $d->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.stockmaster_result_cache'));
        $d->setMetadataDriverImpl($c);
        $d->setProxyDir((__DIR__.'/doctrine/orm/Proxies'));
        $d->setProxyNamespace('Proxies');
        $d->setAutoGenerateProxyClasses(true);
        ...
        $d->setNamingStrategy($this->get('doctrine.orm.naming_strategy.default'));
        $d->setQuoteStrategy($this->get('doctrine.orm.quote_strategy.default'));
        $d->setEntityListenerResolver($this->get('doctrine.orm.stockmaster_entity_listener_resolver'));

        $this->services['doctrine.orm.stockmaster_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.stockmaster_connection'), $d);

        $this->get('doctrine.orm.stockmaster_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.stockmaster_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator A Doctrine\Bundle\DoctrineBundle\ManagerConfigurator instance.
     */
    protected function getDoctrine_Orm_StockmasterManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.stockmaster_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.simplestock2_metadata_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_Simplestock2MetadataCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.simplestock2_metadata_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();

        $instance->setNamespace('sf2orm_simplestock2_87358de531af8c6ba5a2b0868700535d57617eb42058934569c91290f21830e7');

        return $instance;
    }

    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.simplestock2_query_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_Simplestock2QueryCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.simplestock2_query_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.simplestock2_result_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_Simplestock2ResultCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.simplestock2_result_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.stockmaster_metadata_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_StockmasterMetadataCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.stockmaster_metadata_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();

        $instance->setNamespace('sf2orm_stockmaster_87358de531af8c6ba5a2b0868700535d57617eb42058934569c91290f21830e7');

        return $instance;
    }

    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.stockmaster_query_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_StockmasterQueryCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.stockmaster_query_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.stockmaster_result_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_StockmasterResultCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.stockmaster_result_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('stockmaster', $this->get('doctrine.dbal.logger.profiling.stockmaster'));
        $d->addLogger('simplestock2', $this->get('doctrine.dbal.logger.profiling.simplestock2'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'SYM16\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 12))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $h, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($h, '/SimpleStock/home'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        ...
        $j->setOptions(array('login_path' => '/SimpleStock/login', 'default_target_path' => '/SimpleStock/home', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    /**
     * Gets the 'sym16_simple_stock.isunique' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SYM16\SimpleStockBundle\Validator\UniqueEntityByEmValidator A SYM16\SimpleStockBundle\Validator\UniqueEntityByEmValidator instance.
     * 
     * @throws InactiveScopeException when the 'sym16_simple_stock.isunique' service is requested while the 'request' scope is not active
     */
    protected function getSym16SimpleStock_IsuniqueService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('sym16_simple_stock.isunique', 'request');
        }

        return $this->services['sym16_simple_stock.isunique'] = $this->scopedServices['request']['sym16_simple_stock.isunique'] = new \SYM16\SimpleStockBundle\Validator\UniqueEntityByEmValidator($this->get('doctrine'), $this->get('request'));
    }

    /**
     * Gets the 'sym16_simple_stock.lister_tout' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SYM16\SimpleStockBundle\Services\ListerCorrection A SYM16\SimpleStockBundle\Services\ListerCorrection instance.
     */
    protected function getSym16SimpleStock_ListerToutService()
    {
        return $this->services['sym16_simple_stock.lister_tout'] = new \SYM16\SimpleStockBundle\Services\ListerCorrection();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'SYM16SimpleStockBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SYM16/SimpleStockBundle/Resources/views'), 'SYM16SimpleStock');
        $instance->addPath(($this->targetDirs[3].'/src/SYM16/UserBundle/Resources/views'), 'SYM16User');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d23efae17ac0c545027bd294f8cb4f25bfdacba6');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'isunique' => 'sym16_simple_stock.isunique')));
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.simplestock2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance.
     */
    protected function getDoctrine_Dbal_Logger_Profiling_Simplestock2Service()
    {
        return $this->services['doctrine.dbal.logger.profiling.simplestock2'] = new \Doctrine\DBAL\Logging\DebugStack();
    }

    /**
     * Gets the 'doctrine.dbal.logger.profiling.stockmaster' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance.
     */
    protected function getDoctrine_Dbal_Logger_Profiling_StockmasterService()
    {
        return $this->services['doctrine.dbal.logger.profiling.stockmaster'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_TEMPORAIRE' => array(), 'ROLE_EXAMINATEUR' => array(0 => 'ROLE_TEMPORAIRE'), 'ROLE_GESTIONNAIRE' => array(0 => 'ROLE_EXAMINATEUR'), 'ROLE_ADMINISTRATEUR' => array(0 => 'ROLE_GESTIONNAIRE'), 'ROLE_SUPER_UTILISATEUR' => array(0 => 'ROLE_ADMINISTRATEUR', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'SYM16\\UserBundle\\Entity\\User', 'username', 'stockmaster');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SYM16SimpleStockBundle' => 'SYM16\\SimpleStockBundle\\SYM16SimpleStockBundle',
                'SYM16UserBundle' => 'SYM16\\UserBundle\\SYM16UserBundle',
            ...
            'database_user' => 'simplestock',
            'database_password' => 'simplestock',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'd23efae17ac0c545027bd294f8cb4f25bfdacba6',
            'database_name0' => 'stockmaster',
            'database_name2' => 'simplestock2',
            'database_name3' => 'simplestock3',
            'database_name4' => 'simplestock4',
            'database_name5' => 'simplestock5',
            'currentstockname' => 'simplestock',
            ...
            'kernel.secret' => 'd23efae17ac0c545027bd294f8cb4f25bfdacba6',
            ...
            'doctrine.entity_managers' => array(
                ...
                'stockmaster' => 'doctrine.orm.stockmaster_entity_manager',
                'simplestock2' => 'doctrine.orm.simplestock2_entity_manager',
            ),
            ...
            'doctrine.connections' => array(
                ...
                'stockmaster' => 'doctrine.dbal.stockmaster_connection',
                'simplestock2' => 'doctrine.dbal.simplestock2_connection',
            ),
